...
const RockpaperscissorsFeature = lazy(() => import('../components/rockpaperscissors/rockpaperscissors-feature'))
...
const routes: RouteObject[] = [
  ...
  { path: '/rockpaperscissors', element: <RockpaperscissorsFeature /> },
